...
public class PlayerHolder
{
	...
	private TeamHolder _equipo;
	private int _colorName;
	
	public void colocarEquipo(TeamHolder equipo)
	{
		_equipo = equipo;
	}
	
	public TeamHolder tomarEquipo()
	{
		return _equipo;
	}
	
	public L2PcInstance tomarInstancia()
	{
		return L2World.getInstance().getPlayer(getObjectId());
	}
	
	public void saveColorName(int colorName)
	{
		_colorName = colorName;
	}
	
	public int getSaveColorName()
	{
		return _colorName;
	}
}
