...
public final class Q00619_RelicsOfTheOldEmpire extends Quest {
	...
	private static final QuestDroplist DROPLIST = QuestDroplist.builder()
		.addSingleDrop(21396, BROKEN_RELIC_PART, 51.0)
		.addSingleDrop(21396, ENTRANCE_PASS_TO_THE_SEPULCHER) // carrion_scarab
		.addSingleDrop(21397, BROKEN_RELIC_PART, 50.0)
		.addSingleDrop(21396, ENTRANCE_PASS_TO_THE_SEPULCHER) // carrion_scarab_a
		.addSingleDrop(21398, BROKEN_RELIC_PART, 95.0)
		.addSingleDrop(21398, ENTRANCE_PASS_TO_THE_SEPULCHER) // soldier_scarab
		.addSingleDrop(21399, BROKEN_RELIC_PART, 84.0)
		.addSingleDrop(21399, ENTRANCE_PASS_TO_THE_SEPULCHER) // soldier_scarab_a
		.addSingleDrop(21400, BROKEN_RELIC_PART, 76.0)
		.addSingleDrop(21400, ENTRANCE_PASS_TO_THE_SEPULCHER) // hexa_beetle
		.addSingleDrop(21401, BROKEN_RELIC_PART, 67.0)
		.addSingleDrop(21401, ENTRANCE_PASS_TO_THE_SEPULCHER) // hexa_beetle_a
		.addSingleDrop(21402, BROKEN_RELIC_PART, 69.0)
		.addSingleDrop(21402, ENTRANCE_PASS_TO_THE_SEPULCHER) // katraxith
		.addSingleDrop(21403, BROKEN_RELIC_PART, 80.0)
		.addSingleDrop(21403, ENTRANCE_PASS_TO_THE_SEPULCHER) // katraxith_a
		.addSingleDrop(21404, BROKEN_RELIC_PART, 90.0)
		.addSingleDrop(21404, ENTRANCE_PASS_TO_THE_SEPULCHER) // tera_beetle
		.addSingleDrop(21405, BROKEN_RELIC_PART, 64.0)
		.addSingleDrop(21405, ENTRANCE_PASS_TO_THE_SEPULCHER) // tera_beetle_a
		.addSingleDrop(21406, BROKEN_RELIC_PART, 87.0)
		.addSingleDrop(21406, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_knight
		.addSingleDrop(21407, BROKEN_RELIC_PART, 56.0)
		.addSingleDrop(21407, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_knight_a
		.addSingleDrop(21408, BROKEN_RELIC_PART, 82.0)
		.addSingleDrop(21408, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_guard
		.addSingleDrop(21409, BROKEN_RELIC_PART, 92.0)
		.addSingleDrop(21409, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_guard_a
		.addSingleDrop(21410, BROKEN_RELIC_PART, 81.0)
		.addSingleDrop(21410, ENTRANCE_PASS_TO_THE_SEPULCHER) // guardian_scarab
		.addSingleDrop(21411, BROKEN_RELIC_PART, 66.0)
		.addSingleDrop(21411, ENTRANCE_PASS_TO_THE_SEPULCHER) // guardian_scarab_a
		.addSingleDrop(21412, BROKEN_RELIC_PART, 106.0)
		.addSingleDrop(21412, ENTRANCE_PASS_TO_THE_SEPULCHER) // ustralith
		.addSingleDrop(21413, BROKEN_RELIC_PART, 81.0)
		.addSingleDrop(21413, ENTRANCE_PASS_TO_THE_SEPULCHER) // ustralith_a
		.addSingleDrop(21414, BROKEN_RELIC_PART, 79.0)
		.addSingleDrop(21414, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_assassin
		.addSingleDrop(21415, BROKEN_RELIC_PART, 80.0)
		.addSingleDrop(21415, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_assassin_a
		.addSingleDrop(21416, BROKEN_RELIC_PART, 82.0)
		.addSingleDrop(21416, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_warlord
		.addSingleDrop(21417, BROKEN_RELIC_PART, 127.0)
		.addSingleDrop(21417, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_warlord_a
		.addSingleDrop(21418, BROKEN_RELIC_PART, 66.0)
		.addSingleDrop(21418, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_highguard
		.addSingleDrop(21419, BROKEN_RELIC_PART, 67.0)
		.addSingleDrop(21419, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_highguard_a
		.addSingleDrop(21420, BROKEN_RELIC_PART, 82.0)
		.addSingleDrop(21420, ENTRANCE_PASS_TO_THE_SEPULCHER) // ashuras
		.addSingleDrop(21421, BROKEN_RELIC_PART, 77.0)
		.addSingleDrop(21421, ENTRANCE_PASS_TO_THE_SEPULCHER) // ashuras_a
		.addSingleDrop(21422, BROKEN_RELIC_PART, 88.0)
		.addSingleDrop(21422, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_dancer
		.addSingleDrop(21423, BROKEN_RELIC_PART, 94.0)
		.addSingleDrop(21423, ENTRANCE_PASS_TO_THE_SEPULCHER) // imperial_dancer_a
		.addSingleDrop(21424, BROKEN_RELIC_PART, 119.0)
		.addSingleDrop(21424, ENTRANCE_PASS_TO_THE_SEPULCHER) // ashikenas
		.addSingleDrop(21425, BROKEN_RELIC_PART, 121.0)
		.addSingleDrop(21425, ENTRANCE_PASS_TO_THE_SEPULCHER) // ashikenas_a
		.addSingleDrop(21426, BROKEN_RELIC_PART, 108.0)
		.addSingleDrop(21426, ENTRANCE_PASS_TO_THE_SEPULCHER) // abraxian
		.addSingleDrop(21427, BROKEN_RELIC_PART, 74.0)
		.addSingleDrop(21427, ENTRANCE_PASS_TO_THE_SEPULCHER) // abraxian_a
		.addSingleDrop(21428, BROKEN_RELIC_PART, 76.0)
		.addSingleDrop(21428, ENTRANCE_PASS_TO_THE_SEPULCHER) // hasturan
		.addSingleDrop(21429, BROKEN_RELIC_PART, 80.0)
		.addSingleDrop(21429, ENTRANCE_PASS_TO_THE_SEPULCHER) // hasturan_a
		.addSingleDrop(21430, BROKEN_RELIC_PART, 110.0)
		.addSingleDrop(21430, ENTRANCE_PASS_TO_THE_SEPULCHER) // ahrimanes
		.addSingleDrop(21431, BROKEN_RELIC_PART, 94.0)
		.addSingleDrop(21431, ENTRANCE_PASS_TO_THE_SEPULCHER) // ahrimanes_a
		.addSingleDrop(21432, BROKEN_RELIC_PART, 134.0)
		.addSingleDrop(21432, ENTRANCE_PASS_TO_THE_SEPULCHER) // chakram_beetle
		.addSingleDrop(21433, BROKEN_RELIC_PART, 134.0)
		.addSingleDrop(21433, ENTRANCE_PASS_TO_THE_SEPULCHER) // jamadhr_beetle
		.addSingleDrop(21434, BROKEN_RELIC_PART, 190.0)
		.addSingleDrop(21434, ENTRANCE_PASS_TO_THE_SEPULCHER) // priest_of_blood
		.addSingleDrop(21435, BROKEN_RELIC_PART, 160.0)
		.addSingleDrop(21435, ENTRANCE_PASS_TO_THE_SEPULCHER) // sacrifice_guide
		.addSingleDrop(21436, BROKEN_RELIC_PART, 166.0)
		.addSingleDrop(21436, ENTRANCE_PASS_TO_THE_SEPULCHER) // sacrifice_bearer
		.addSingleDrop(21437, BROKEN_RELIC_PART, 69.0)
		.addSingleDrop(21437, ENTRANCE_PASS_TO_THE_SEPULCHER) // sacrifice_scarab
		.addSingleDrop(21798, BROKEN_RELIC_PART, 33.0)
		.addSingleDrop(21798, ENTRANCE_PASS_TO_THE_SEPULCHER) // guard_skeleton_2d
		.addSingleDrop(21799, BROKEN_RELIC_PART, 61.0)
		.addSingleDrop(21799, ENTRANCE_PASS_TO_THE_SEPULCHER) // guard_skeleton_3d
		.addSingleDrop(21800, BROKEN_RELIC_PART, 31.0)
		.addSingleDrop(21800, ENTRANCE_PASS_TO_THE_SEPULCHER) // guard_undead
		...
		.bulkAddSingleDrop(BROKEN_RELIC_PART, 379.0)
		.withNpcs(ARCHON_OF_HALISHA)
		.build()
		.build();
