...
public final class Q00219_TestimonyOfFate extends Quest {
	...
	private static final QuestDroplist DROPLIST = QuestDroplist.builder()
		.bulkAddSingleDrop(NIGHTSHADE_ROOT)
		.withNpcs(MARSH_STAKATO, MARSH_STAKATO_WORKER, MARSH_STAKATO_SOLDIER, MARSH_STAKATO_DRONE)
		.withRequiredItems(IXIAS_LIST)
		.build()
		.addSingleDrop(MEDUSA, MEDUSAS_ICHOR)
		.withRequiredItems(IXIAS_LIST)
		.bulkAddSingleDrop(TYRANTS_BLOOD)
		.withNpcs(TYRANT, TYRANT_KINGPIN)
		.withRequiredItems(IXIAS_LIST)
		.build()
		.addSingleDrop(DEAD_SEEKER, DEAD_SEEKER_DUNG)
		.withRequiredItems(IXIAS_LIST)
		.addSingleDrop(MARSH_SPIDER, MARSH_SPIDER_FLUIDS)
		.withRequiredItems(IXIAS_LIST)
		.build();
	// Reward
